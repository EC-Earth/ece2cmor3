...
def initialize(path, expname, tableroot, refdate, climdir=None, testmode=False):
    global log, nemo_files_, bathy_file_, basin_file_, exp_name_, table_root_, ref_date_, clim_dir_, test_mode_
    exp_name_ = expname
