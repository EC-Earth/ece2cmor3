...
# LEG       is the leg number for the current job to cmorise. Note for instance leg number one is written as 001.
 ...
 if [ "$#" -eq 3 ]; then
  ...
  echo "  for member in {021..030}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {031..040}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {041..050}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {051..060}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {061..070}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {071..080}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {081..090}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo "  for member in {091..100}; do for leg in {001..008}; do      sbatch --job-name=cmorise-ifs-\${member}-\${leg} $0 ifs \${member} \${leg}; done; done"
  echo
