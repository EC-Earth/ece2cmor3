...
# LEG       is the leg number for the current job to cmorise. Note for instance leg number one is written as 001.
 ...
 if [ "$#" -eq 2 ]; then
  ...
  #METADATA=/nfs/home/users/reerink/cmorize/ece2cmor3/ece2cmor3/resources/metadata-templates/cmip6-CMIP-piControl-metadata-template.json
   METADATA=/nfs/home/users/reerink/ec-earth-3.3.0/branch-r6705-control-output-files/runtime/classic/ctrl/cmip6-output-control-files/CMIP/EC-EARTH-AOGCM/cmip6-experiment-CMIP-piControl/metadata-cmip6-CMIP-piControl-EC-EARTH-AOGCM-$COMPONENT-template.json
   TEMPDIR=/lustre2/projects/model_testing/reerink/cmor-temp-dir/$EXP/$COMPONENT/$LEG
   VARLIST=/nfs/home/users/reerink/ec-earth-3.3.0/branch-r6705-control-output-files/runtime/classic/ctrl/cmip6-output-control-files/CMIP/EC-EARTH-AOGCM/cmip6-experiment-CMIP-piControl/cmip6-data-request-varlist-CMIP-piControl-EC-EARTH-AOGCM.json
   ODIR=/lustre2/projects/model_testing/reerink/cmorised-results/cmor-cmip-piControl/$EXP/$COMPONENT/$LEG
