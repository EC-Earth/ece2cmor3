...
# Step 4: Temporary overwrite the basic identifiedmissing and basic ignored files by their corresponding pre-* ones:
  rsync -a ${HOME}/cmorize/ece2cmor3/ece2cmor3/resources/pre-list-of-identified-missing-cmpi6-requested-variables.xlsx             ${HOME}/cmorize/ece2cmor3/ece2cmor3/resources/list-of-identified-missing-cmpi6-requested-variables.xlsx
  rsync -a ${HOME}/cmorize/ece2cmor3/ece2cmor3/resources/pre-list-of-ignored-cmpi6-requested-variables.xlsx                        ${HOME}/cmorize/ece2cmor3/ece2cmor3/resources/list-of-ignored-cmpi6-requested-variables.xlsx
...
# Step 6: Copy the resulting identifiedmissing and ignored produced by the checkvars.py to the basic identifiedmissing and the basic ignored:
   rsync -a cmvmm-all-mips-t=3-p=3.identifiedmissing.xlsx ../resources/list-of-identified-missing-cmpi6-requested-variables.xlsx
   rsync -a cmvmm-all-mips-t=3-p=3.ignored.xlsx           ../resources/list-of-ignored-cmpi6-requested-variables.xlsx
...
#  -Move manually the Antarctic IfxAnt, and ImonAnt variables                              from the list-of-identified-missing-cmpi6-requested-variables.xlsx to the list-of-ignored-cmpi6-requested-variables.xlsx and adjust the comment.
#  -Move manually the CFsubhr AerChemMIP variables (one block of variables)                from the list-of-identified-missing-cmpi6-requested-variables.xlsx to the list-of-ignored-cmpi6-requested-variables.xlsx
#  -Move manually the Esubhr tnhus, reffclws                                               from the list-of-identified-missing-cmpi6-requested-variables.xlsx to the list-of-ignored-cmpi6-requested-variables.xlsx
...
#  -Add  manually the AERmon  co2  #589                                                      to the list-of-ignored-cmpi6-requested-variables.xlsx
#  -Add  manually the E3hrPt  co2  #589                                                      to the list-of-ignored-cmpi6-requested-variables.xlsx
