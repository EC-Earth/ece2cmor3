...
if [ "$#" -eq 0 ]; then
 ...
 if [ add_rescue_variables ]; then
  ...
  #  fBECCS:    fFire (annual)
  #  fBEatm:    fFire (annual)
  #  fStemManaf fFire (annual)
  #  cStemManaf cVeg  (annual)
  #  cDACCS:    co2mass
 ...
 #git checkout ${table_file_Eyr}  # Do not apply because of the optimes modifications
  ...
  sed -i  '/"cLitter": {/i \
        ...
        "cStemManaf": {                                                                                \
            "frequency": "yrPt",                                                                       \
            "modeling_realm": "land",                                                                  \
            "standard_name": "stem_carbon_in_managed_forest",                                          \
            "units": "kg m-2",                                                                         \
            "cell_methods": "area: mean where land time: point",                                       \
            "cell_measures": "area: areacella",                                                        \
            "long_name": "Total standing stem carbon in managed forest",                               \
            "comment": "Total carbon in stems of standing trees in a managed forest",                  \
            "dimensions": "longitude latitude time1",                                                  \
            "out_name": "cStemManaf",                                                                  \
            "type": "real",                                                                            \
            "positive": "",                                                                            \
        ...
        "fStemManaf": {                                                                                \
            "frequency": "yr",                                                                         \
            "modeling_realm": "land",                                                                  \
            "standard_name": "harvested_stem_carbon_from_managed_forest",                              \
            "units": "kg m-2 s-1",                                                                     \
            "cell_methods": "area: mean where land time: mean",                                        \
            "cell_measures": "area: areacella",                                                        \
            "long_name": "Total amount of stem carbon harvested from managed forest",                  \
            "comment": "Total carbon harvested from stems of standing trees in a managed forest",      \
            "dimensions": "longitude latitude time",                                                   \
            "out_name": "fStemManaf",                                                                  \
            "type": "real",                                                                            \
            "positive": "up",                                                                          \
