  ...
  for grid_ref_value in grid_ref_overview:
   ...
   #print ' Number of fields per file is {:3} for the combination: {:7} {:4} {}'.format(number_of_fields_per_file, component_value, output_freq_value, grid_ref_value)
    ...
    #print 'tttt'+written_field.text+'tttt'  # To figure out the spaces in the string around None
     ...
     basic_nemo_file_def_xml_file.write(  '     <field id={:40} name={:25} table={:15} field_ref={:40} grid_ref={:32} output_freq={:20} enable="False" > {:70} </field>\n'.format('"'+written_field.attrib["id"]+'"', '"'+written_field.attrib["name"]+'"', '"'+written_field.attrib["table"]+'"', '"'+written_field.attrib["field_ref"]+'"', '"'+written_field.attrib["grid_ref"]+'"', '"'+written_field.attrib["output_freq"]+'"', written_field.text))
    basic_nemo_file_def_xml_file.write(  '\n    </file>\n')
