...
Mapping of one CMIP6 table-variable combination:
 ./cmip6-cmip7-variable-mapping.py v1.2.2.5 -t Amon -v tas

Multiple mapping of various variables from various tables:
 ./cmip6-cmip7-variable-mapping.py v1.2.2.5 -t Omon,Amon -v tas,tos

Mapping of two CMIP7 compound names:
 ./cmip6-cmip7-variable-mapping.py v1.2.2.5 -c atmos.areacell.ti-u-hxy-u.fx.glb,ocean.areacell.ti-u-hxy-u.fx.glb

Mapping of all variables:
 ./cmip6-cmip7-variable-mapping.py v1.2.2.5 -r
