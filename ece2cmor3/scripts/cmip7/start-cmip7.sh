 ...
 ./combine-and-merge-json-request-files.py bup/optimesm/optimesm-v03/optimesm-request-EC-EARTH-ESM-1-varlist.json cmip7/bup/output-control-files-ECE3-ESM-1-CMIP7-esm-hist-core-v03/cmip7/esm-hist-core-EC-Earth3-ESM-1/component-request-cmip7-esm-hist-core-EC-Earth3-ESM-1.json combinded-optimesm-cmip7-core-request-EC-EARTH-ESM-1-varlist.json
 ./combine-and-merge-json-request-files.py bup/optimesm/optimesm-v03/optimesm-request-EC-EARTH-ESM-1-varlist.json cmip7/bup/output-control-files-ECE3-ESM-1-CMIP7-esm-hist-high-v03/cmip7/esm-hist-high-EC-Earth3-ESM-1/component-request-cmip7-esm-hist-high-EC-Earth3-ESM-1.json combinded-optimesm-cmip7-high-request-EC-EARTH-ESM-1-varlist.json

 # Create the output-control-files for the combined OptimESM - CMIP7-FT request:
 ./genecec-for-individual-experiments.sh combinded-optimesm-cmip7-core-request-EC-EARTH-ESM-1-varlist.json                                           CMIP        esm-hist                 EC-EARTH-ESM-1   bup/optimesm/optimesm-cmip7-ft-core-v01  &> genecec-for-individual-experiments-optimesm-cmip7-ft-core.log
 ./genecec-for-individual-experiments.sh combinded-optimesm-cmip7-high-request-EC-EARTH-ESM-1-varlist.json                                           CMIP        esm-hist                 EC-EARTH-ESM-1   bup/optimesm/optimesm-cmip7-ft-high-v01  &> genecec-for-individual-experiments-optimesm-cmip7-ft-high.log
...
#  The CMIP7 - CMIP6 units check (CMIP7 units are used), two cases show up:
#   case 1: CMIP7 unit: kg m-2 s-1  not equal to CMIP6 unit: mol s-1            for aerosol.emilnox.tavg-u-hxy-u.mon.glb     https://clipc-services.ceda.ac.uk/dreq/u/534001c2fd879bfda1d9b66d0a61144c.html
#   case 2: CMIP7 unit: kg m-2 s-1  not equal to CMIP6 unit: 2 s-1] kg m-2 s-1  for land.fLitterFire.tavg-u-hxy-lnd.mon.glb  https://clipc-services.ceda.ac.uk/dreq/u/5914f2a8-9e49-11e5-803c-0d0b866b59f3.html thus CMIP6 should also be: kg m-2 s-1 , so CMIP7 is OK
#   case 1:
#    <variable  cmip6_table="AERmon"     cmip6_variable="emilnox"             region="glb"      temporal_shape="time-intv"                cmip7_compound_name="aerosol.emilnox.tavg-u-hxy-u.mon.glb"              dimensions="longitude latitude alevel time"              unit="mol s-1"            varname_code="emilnox"               ifs_shortname="NotAnIFSvar"    model_component="tm5"     other_component="None"    cmip7_long_name="Layer-Integrated Lightning Production of NOx"                                                                                      long_name="Layer-Integrated Lightning Production of NOx"                                                                           expression="None"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         comment="tm5  code name = emilnox"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             >   </variable>
#    <variable  cmip7_compound_name="aerosol.emilnox.tavg-u-hxy-u.mon.glb"                  priority="High"     status="identified"         model_component="tm5"      other_component="None"   ifs_shortname="NotAnIFSvar" varname_code="emilnox"            comment_author="                 "  comment="                                                                        "  expression="None"                                                                              frequency="mon"   region="glb"        cmip6_table="AERmon"       physical_parameter_name="emilnox"                    units="kg m-2 s-1"         dimensions="longitude latitude time"                     long_name="Layer-Integrated Lightning Production of NOx"                                                                                       standard_name="tendency_of_atmosphere_mass_content_of_nox_expressed_as_nitrogen_due_to_emission"                                                                               modeling_realm="aerosol"                         branded_variable_name="emilnox_tavg-u-hxy-u"                       branding_label="tavg-u-hxy-u"            cmip6_compound_name="AERmon.emilnox"                         temporal_shape="time-intv"               spatial_shape="XY-na"         cell_measures="area: areacella"                   cell_methods="area: time: mean"                                                                                                                           out_name="emilnox"                    type="real"     >   </variable>
#   case 2:
#    <variable  cmip6_table="Emon"       cmip6_variable="fLitterFire"         region="glb"      temporal_shape="time-intv"                cmip7_compound_name="land.fLitterFire.tavg-u-hxy-lnd.mon.glb"           dimensions="longitude latitude time"                     unit="2 s-1] kg m-2 s-1"  varname_code="fLitterFire"           ifs_shortname="NotAnIFSvar"    model_component="lpjg"    other_component="None"    cmip7_long_name="Carbon Mass Flux from Litter, CWD or any non-Living Pool into Atmosphere Due to CO2 Emission from All Fire [kgC m-2 s-1]"          long_name="Carbon Mass Flux from Litter, CWD or any non-Living Pool into Atmosphere Due to CO2 Emission from All Fire [kgC m-"     expression="None"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         comment="lpjg code name = fLitterFire"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         >   </variable>
#    <variable  cmip7_compound_name="land.fLitterFire.tavg-u-hxy-lnd.mon.glb"               priority="Medium"   status="identified"         model_component="lpjg"     other_component="None"   ifs_shortname="NotAnIFSvar" varname_code="fLitterFire"        comment_author="                 "  comment="                                                                        "  expression="None"                                                                              frequency="mon"   region="glb"        cmip6_table="Emon"         physical_parameter_name="fLitterFire"                units="kg m-2 s-1"         dimensions="longitude latitude time"                     long_name="Carbon Mass Flux from Litter, CWD or any non-Living Pool into Atmosphere Due to CO2 Emission from All Fire [kgC m-2 s-1]"           standard_name="surface_upward_mass_flux_of_carbon_dioxide_expressed_as_carbon_due_to_emission_from_litter_in_fires"                                                            modeling_realm="land"                            branded_variable_name="fLitterFire_tavg-u-hxy-lnd"                 branding_label="tavg-u-hxy-lnd"          cmip6_compound_name="Emon.fLitterFire"                       temporal_shape="time-intv"               spatial_shape="XY-na"         cell_measures="area: areacella"                   cell_methods="area: mean where land time: mean"                                                                                                           out_name="fLitterFire"                type="real"     >   </variable>
